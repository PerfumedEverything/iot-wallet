...
class _RestoreWalletScreenState extends State<RestoreWalletScreen> {
  ...
  Future<String> importAccount(String mnemonic) async {
      try {
        ...
        ton.KeyPair keys = await compute(_genNewKey, words);

        var wallet = ton.WalletContractV4R2.create(publicKey: keys.publicKey);
   ...
   static ton.KeyPair _genNewKey (List<String> mnemonics) {
